...
export const AddRouteModal = ({ show, handleClose, handleAddRoute, handleNewRouteChange, newRoute }) => {
  return (
        ...
        <Form>
          <Form.Group controlId="departureCity">
            ...
            <AutocompleteInput
              ...
              onChange={(value) => handleNewRouteChange('departure_city_province', value)}
              onSelect={(suggestion) => {
                ...
                handleNewRouteChange('departure_province_id', suggestion.province_id);
                handleNewRouteChange('departure_city_province', suggestion.city_province);
              }}
            />
          </Form.Group>
          <Form.Group controlId="arrivalCity">
            ...
            <AutocompleteInput
              ...
              onChange={(value) => handleNewRouteChange('arrival_city_province', value)}
              onSelect={(suggestion) => {
                ...
                handleNewRouteChange('arrival_province_id', suggestion.province_id);
                handleNewRouteChange('arrival_city_province', suggestion.city_province);
              }}
            />
          </Form.Group>
